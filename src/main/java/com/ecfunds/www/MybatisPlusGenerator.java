...
public class MybatisPlusGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("louyy");
        globalConfig.setOpen(false);
        DataSourceConfig dataSourceConfig = new DataSourceConfig();
        dataSourceConfig.setUrl("jdbc:mysql://47.106.244.113:3306/crowdfunding?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&verifyServerCertificate=false&useSSL=false");
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver");
        dataSourceConfig.setUsername("root");
        dataSourceConfig.setPassword("123456");
        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName("www");
        pc.setParent("com.ecfunds");
